...
and well-versed in a wide range of skills that include back-end development using open source technologies (NodeJs), front-end development (ReactJs, HTML5, CSS3, Javascript, Responsive, UX, Redux, Redux Toolkit), database(MongoDB), web sockets (Socket.io) and worked in ElectronJS, Java & Mysql database.
